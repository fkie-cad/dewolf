...
from decompiler.structures.pseudo import Constant, FunctionSymbol, ImportedFunctionSymbol, Integer, Symbol
...
class SymbolHandler(Handler):
    ...
    def lift_symbol(self, symbol: CoreSymbol, **kwargs) -> Constant:
