...
class Z3Converter:
    ...
    def convert(self, expression: Union[Expression, Branch]) -> BitVecRef:
        """Convert the given expression or Branch into a z3 logic statement."""
        ...
        raise ValueError(f"Could not convert {expression} into z3 logic.")
    ...
    def check(self, *terms: BoolRef, timeout: int = 2000) -> str:
    ...
    def is_not_satisfiable(self, *terms: BoolRef, timeout: int = 2000) -> bool:
        """Check whether a given set of terms is not satisfiable."""
        return self.check(*terms, timeout=timeout) == "unsat"

    def is_satisfiable(self, *terms: BoolRef, timeout: int = 2000) -> bool:
        """Check whether a given set of terms is satisfiable."""
        return self.check(*terms, timeout=timeout) == "sat"
