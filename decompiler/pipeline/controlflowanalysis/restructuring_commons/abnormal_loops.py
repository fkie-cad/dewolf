...
from decompiler.structures.ast.condition_symbol import ConditionSymbol
...
from decompiler.structures.pseudo import Assignment, Condition, Constant, Integer, OperationType, Variable
