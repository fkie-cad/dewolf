...
def test_nested_dowhile_loop_rule_continue_interruption():
    """
    ...
    assert NestedDoWhileLoopRule.can_be_applied(root) is True


def test_nested_dowhile_loop_rule_break_interruption():
    """
    Nested-DoWhile Restructuring (NestedDoWhileLoopRule) should not transform!
