...
@pytest.mark.parametrize(
    ...
    [
        ...
        (OperationType.plus, [_c_i32(3)], Integer.int32_t(), None, pytest.raises(MalformedInput)),
        (OperationType.plus, [_c_i32(3), _c_i32(3), _c_i32(3)], Integer.int32_t(), None, pytest.raises(MalformedInput)),
        ...
        (OperationType.minus, [_c_i32(3)], Integer.int32_t(), None, pytest.raises(MalformedInput)),
        (OperationType.minus, [_c_i32(3), _c_i32(3), _c_i32(3)], Integer.int32_t(), None, pytest.raises(MalformedInput)),
        ...
        (OperationType.multiply, [_c_i32(3)], Integer.int32_t(), None, pytest.raises(MalformedInput)),
        (OperationType.multiply, [_c_i32(3), _c_i32(3), _c_i32(3)], Integer.int32_t(), None, pytest.raises(MalformedInput)),
        ...
        (OperationType.multiply_us, [_c_i32(3)], Integer.int32_t(), None, pytest.raises(MalformedInput)),
        (OperationType.multiply_us, [_c_i32(3), _c_i32(3), _c_i32(3)], Integer.int32_t(), None, pytest.raises(MalformedInput)),
        ...
        (OperationType.divide, [_c_i32(3)], Integer.int32_t(), None, pytest.raises(MalformedInput)),
        (OperationType.divide, [_c_i32(3), _c_i32(3), _c_i32(3)], Integer.int32_t(), None, pytest.raises(MalformedInput)),
        ...
        (OperationType.divide_us, [_c_i32(3)], Integer.int32_t(), None, pytest.raises(MalformedInput)),
        (OperationType.divide_us, [_c_i32(3), _c_i32(3), _c_i32(3)], Integer.int32_t(), None, pytest.raises(MalformedInput)),
        ...
        (OperationType.negate, [], Integer.int32_t(), None, pytest.raises(MalformedInput)),
        (OperationType.negate, [_c_i32(3), _c_i32(3)], Integer.int32_t(), None, pytest.raises(MalformedInput)),
        ...
        (OperationType.left_shift, [_c_i32(3)], Integer.int32_t(), None, pytest.raises(MalformedInput)),
        (OperationType.left_shift, [_c_i32(3), _c_i32(3), _c_i32(3)], Integer.int32_t(), None, pytest.raises(MalformedInput)),
        ...
        (OperationType.right_shift, [_c_i32(3)], Integer.int32_t(), None, pytest.raises(MalformedInput)),
        (OperationType.right_shift, [_c_i32(3), _c_i32(3), _c_i32(3)], Integer.int32_t(), None, pytest.raises(MalformedInput)),
        ...
        (OperationType.right_shift_us, [_c_i32(3)], Integer.int32_t(), None, pytest.raises(MalformedInput)),
        (OperationType.right_shift_us, [_c_i32(3), _c_i32(3), _c_i32(3)], Integer.int32_t(), None, pytest.raises(MalformedInput)),
        ...
        (OperationType.bitwise_or, [_c_i32(3)], Integer.int32_t(), None, pytest.raises(MalformedInput)),
        (OperationType.bitwise_or, [_c_i32(3), _c_i32(3), _c_i32(3)], Integer.int32_t(), None, pytest.raises(MalformedInput)),
        ...
        (OperationType.bitwise_and, [_c_i32(3)], Integer.int32_t(), None, pytest.raises(MalformedInput)),
        (OperationType.bitwise_and, [_c_i32(3), _c_i32(3), _c_i32(3)], Integer.int32_t(), None, pytest.raises(MalformedInput)),
        ...
        (OperationType.bitwise_xor, [_c_i32(3)], Integer.int32_t(), None, pytest.raises(MalformedInput)),
        (OperationType.bitwise_xor, [_c_i32(3), _c_i32(3), _c_i32(3)], Integer.int32_t(), None, pytest.raises(MalformedInput)),
        ...
        (OperationType.bitwise_not, [], Integer.int32_t(), None, pytest.raises(MalformedInput)),
        (OperationType.bitwise_not, [_c_i32(3), _c_i32(3)], Integer.int32_t(), None, pytest.raises(MalformedInput)),
    ]
)
