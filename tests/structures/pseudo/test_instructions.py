...
class TestMemPhi:
    ...
    def test_create_phi_for_variables(self):
        ...
        g6, g3, g4, g5 = (GlobalVariable("g", Integer.char(), initial_value=Constant(42), ssa_label=i) for i in ssa_labels)
        ...
        g = GlobalVariable("g", Integer.char(), initial_value=Constant(42))
