...
from dewolf.structures.pseudo import Assignment, BaseAssignment, BinaryOperation, Instruction, OperationType, Phi, UnaryOperation, Variable
from dewolf.structures.pseudo.typing import Pointer
