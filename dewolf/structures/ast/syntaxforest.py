...
from dewolf.structures.graphs.restructuring_graph.transition_cfg import TransitionBlock
from dewolf.structures.logic.logic_condition import LogicCondition
from dewolf.structures.pseudo import Break, Constant, Expression, Instruction, Variable
