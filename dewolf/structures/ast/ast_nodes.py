...
from dewolf.structures.ast.reachability_graph import CaseDependencyGraph, SiblingReachability
...
from dewolf.structures.pseudo import Assignment, Break, Condition, Constant, Continue, Expression, Instruction, Return, Variable
