...
from dewolf.structures.pseudo.instructions import Assignment, BaseAssignment, Instruction, Relation
from dewolf.structures.pseudo.operations import BinaryOperation, Call, ListOperation, OperationType, UnaryOperation
