...
from dewolf.structures.pseudo.expressions import GlobalVariable, Variable
from dewolf.structures.pseudo.instructions import BaseAssignment, Instruction, Relation
from dewolf.structures.pseudo.typing import Type
